...
class MetaTagsService
{
    ...
    public function setMetaTags($query){
        ...
        $result = match($query) {
            'announcementType=1' => [
                'title' => 'Daşınmaz əmlak satışı. Alqı-satqı elanları (2024 parametr)',
            ...
            'announcementType=2' => [
                'title' => 'Daşınmaz əmlak kirayəsi. Kirayə elanları (2024 parametr)',
            ...
            'credit_possible=true' => [
                'title' => 'İpoteka ilə mənzil satışı, ipotekaya uyğun çıxarışlı evlər (2024 parametr)',
            ...
            'announcementType=2&rental_type=2' => [
                'title' => 'Günlük kirayə evlər. Günlük kirayə mənzillər və bağ evləri (2024 parametr)',
            ...
            'client_types_for_rent=4' => [
                'title' => 'Tələbələr üçün kirayə evlər (2024 parametr)',
            ...
            'room_ids=2' => [
                'title' => '2 otaqlı mənzil qiymətləri, 2 otaqlı mənzil elanları (2024 parametr)',
            ...
            'city=1&propertyType=6' => [
                'title' => 'Bakıda ffis elanları, ofislərin satışı və icarəsi (2024 parametr)',
            ...
            'apartment_type=1' => [
                'title' => 'Yeni tikili mənzillər (2024 parametr)',
            ...
            'propertyType=1' => [
                'title' => 'Mənzil alqı-satqısı elanları (2024 parametr)',
            ...
            'propertyType=2' => [
                'title' => 'Həyət evi elanları (2024 parametr)',
            ...
            default => [
                'title' => 'Ən yeni daşınmaz əmlak satışı və kirayəsi elanları (2024 parametr)',
