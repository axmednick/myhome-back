...
<head>
    ...
    <style>          img {
        ...
        #dataBlockId-11 p, #dataBlockId-11 h1, #dataBlockId-11 h2, #dataBlockId-11 h3, #dataBlockId-11 h4, #dataBlockId-11 ul {
            text-align: center;
        }
    ...
    <script>!function () {
            function o(n, i) {
                if (n && i) for (var r in i) i.hasOwnProperty(r) && (void 0 === n[r] ? n[r] = i[r] : n[r].constructor === Object && i[r].constructor === Object ? o(n[r], i[r]) : n[r] = i[r])
            }
    ...
    <script>!function (a) {
            ...
            }(), "400".length > 0) if (a && "performance" in a && a.performance && "function" == typeof a.performance.setResourceTimingBufferSize) a.performance.setResourceTimingBufferSize(400);
            !function () {
                if (BOOMR = a.BOOMR || {}, BOOMR.plugins = BOOMR.plugins || {}, !BOOMR.plugins.AK) {
                    var e = "" == "true" ? 1 : 0, t = "",
                        n = "2wnab7qx2ycvkzublboq-f-071d425b8-clientnsv4-s.akamaihd.net", i = "false" == "true" ? 2 : 1,
                        _ = {
                            "ak.v": "37",
                            "ak.cp": "405188",
                            "ak.ai": parseInt("287436", 10),
                            "ak.ol": "0",
                            "ak.cr": 56,
                            "ak.ipv": 4,
                            "ak.proto": "h2",
                            ...
                            "ak.acc": "",
                            "ak.t": "1719752797",
                            "ak.ak": "hOBiQwZUYzCg5VSAfCLimQ==",
                            "ak.pv": "98",
                            "ak.dpoabenc": "",
                            "ak.tf": i
                        };
...
<!--[if !gte mso 9]><!----><span class="mcnPreviewText"
                                 style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;"> Elə indi qeydiyyatdan keçin, 10 elan yerləşdirin və 200₼ bonus balansı əldə edin! Bir ay ərzində istənilən qədər ödənişsiz elan yerləşdirmək mümkündür. </span>
<!--<![endif]-->
<!--*|END:IF|*-->
<center>
                                ...
                                <tr>
                                    <td style="background-color:#ffffff;background-position:center;background-repeat:no-repeat;background-size:cover"
                                        ...
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                               role="presentation" data-block-id="14">
                                            <tbody>
                                            <tr class="mceRow">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td style="padding-top:0;padding-bottom:0" class="mceColumn"
                                                                data-block-id="-10" valign="top" colspan="12"
                                                                width="100%">
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding-top:12px;padding-bottom:12px;padding-right:48px;padding-left:48px"
                                                                            ...
                                                                            valign="top"><a href="https://myhome.az/"
                                                                                            style="display:block"
                                                                                            target="_blank"
                                                                                            data-block-id="3"><span
                                                                                    class="mceImageBorder"
                                                                                    style="border:0;vertical-align:top;margin:0"><img
                                                                                        width="341" height="auto"
                                                                                        style="width:341px;height:auto;max-width:341px !important;display:block"
                                                                                        alt=""
                                                                                        src="https://mcusercontent.com/f0f6e87bb66f8a0837575b1f2/images/1d9e7ce2-21e9-1af6-3ff3-e36a0e33b0c4.png"
                                                                                        role="presentation"
                                                                                             ...
                                                                                             style="width:100%"><h1
                                                                                                ...
                                                                                                class="last-child"><span
                                                                                                    style="font-size: 27px"><span
                                                                                                        style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif">Daşınmaz əmlak elanlarınızı MyHome.az saytında yerləşdirin, 200 AZN bonus əldə edin!</span></span>
                                                                                            </h1></div>
                                                                                    </td>
                                                                                </tr>
                                                                                </tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px"
                                                                                        ...
                                                                                        <div data-block-id="6"
                                                                                             ...
                                                                                             id="dataBlockId-6"
                                                                                             style="width:100%"><p
                                                                                                class="last-child">Elə
                                                                                                indi qeydiyyatdan keçin,
                                                                                                10 elan yerləşdirin və
                                                                                                <strong>200₼
                                                                                                    bonus</strong>
                                                                                                balansı əldə edin! Bir
                                                                                                ay ərzində istənilən
                                                                                                qədər ödənişsiz elan
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding-top:12px;padding-bottom:12px;padding-right:12px;padding-left:12px"
                                                                            ...
                                                                            <table align="center" border="0"
                                                                                   cellpadding="0" cellspacing="0"
                                                                                   role="presentation" data-block-id="7"
                                                                                   class="mceButtonContainer">
                                                                                <tbody>
                                                                                <tr><!--[if !mso]><!--></tr>
                                                                                <tr class="mceStandardButton">
                                                                                    <td style="background-color:#005bff;border-radius:8px;text-align:center"
                                                                                        class="mceButton" valign="top">
                                                                                        <a href="https://myhome.az/elan-ver"
                                                                                           target="_blank"
                                                                                           class="mceButtonLink"
                                                                                           style="background-color:#005bff;border-radius:8px;border:1px solid #ffffff;color:#ffffff;display:block;font-family:'Helvetica Neue', Helvetica, Arial, Verdana, sans-serif;font-size:16px;font-weight:normal;font-style:normal;padding:16px 28px;text-decoration:none;min-width:30px;text-align:center;direction:ltr;letter-spacing:0px">Elan
                                                                                            yerləşdir</a></td>
                                                                                </tr>
                                                                                <tr><!--<![endif]--></tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="center">
                                                                                        <v:roundrect
                                                                                            ...
                                                                                            href="https://myhome.az/elan-ver"
                                                                                            style="v-text-anchor:middle; width:152.96px; height:52px;"
                                                                                            arcsize="5%"
                                                                                            strokecolor="#ffffff"
                                                                                            strokeweight="1px"
                                                                                            fillcolor="#005bff">
                                                                                                                ...
                                                                                                                <table
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td style="padding-left:24px;padding-top:0;padding-right:24px"
                                                                                                                            ...
                                                                                                                            valign="top"
                                                                                                                            class="mobileClass-5">
                                                                                                                            <a href="https://www.facebook.com/profile.php?id=61557416723980"
                                                                                                                               style="display:block"
                                                                                                                               target="_blank"
                                                                                                                               data-block-id="-5"><span
                                                                                                                                    class="mceImageBorder"
                                                                                                                                    style="border:0;vertical-align:top;margin:0"><img
                                                                                                                                        width="40"
                                                                                                                                        height="auto"
                                                                                                                                        style="width:40px;height:auto;max-width:40px !important;display:block"
                                                                                                                                        alt="Facebook icon"
                                                                                                                                        src="https://cdn-images.mailchimp.com/icons/social-block-v3/block-icons-v3/facebook-filled-dark-40.png"
                                                                                                                                        class="mceSocialIcon"/></span></a>
                                                                                                                        </td>
                                                                                                                        <td style="padding-left:24px;padding-top:0;padding-right:24px"
                                                                                                                            data-breakpoint="5"
                                                                                                                            valign="top"
                                                                                                                            class="mobileClass-5">
                                                                                                                            <a href="https://www.instagram.com/myhomeaze/"
                                                                                                                               style="display:block"
                                                                                                                               target="_blank"
                                                                                                                               data-block-id="-6"><span
                                                                                                                                    class="mceImageBorder"
                                                                                                                                    style="border:0;vertical-align:top;margin:0"><img
                                                                                                                                        width="40"
                                                                                                                                        height="auto"
                                                                                                                        ...
                                                                                                                        <td style="padding-left:24px;padding-top:0;padding-right:24px"
                                                                                                                            ...
                                                                                                                            valign="top"
                                                                                                                            class="mobileClass-5">
                                                                                                                            <a href="https://myhome.az/"
                                                                                                                               style="display:block"
                                                                                                                               target="_blank"
                                                                                                                               data-block-id="-7"><span
                                                                                                                                    class="mceImageBorder"
                                                                                                                                    style="border:0;vertical-align:top;margin:0"><img
                                                                                                                                        width="40"
                                                                                                                                        height="auto"
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding-top:8px;padding-bottom:8px;padding-right:8px;padding-left:8px"
                                                                            ...
                                                                            <table align="center" border="0"
                                                                                   ...
                                                                                   width="100%" role="presentation"
                                                                                   data-block-id="13"
                                                                                   id="section_1a83f2a39a322d307d6350b66df017f3"
...
<script type="text/javascript" src="/F4R5/X9h4/O5q/x56/mmOw/1tu3rNfV0f5t/HxNednQ/EDE2cSo/YBAUB"></script>
</body>
</html>
